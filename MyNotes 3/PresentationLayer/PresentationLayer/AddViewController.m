...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(createNoteFinishedNotification:) name:@"createNoteFinished" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(createNoteFailedNotification:) name:@"createNoteFailed" object:nil];
